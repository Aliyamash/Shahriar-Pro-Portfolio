  ...
  return (
    <div className="container mx-auto px-5 mb-50 lg:p-28">
      <div data-aos="fade-up">
        <p
          className="text-redBody lg:text-lg  font-bold text-center mt-16 lg:mt-0"
          id="myresume-section"
        >
      ...
      <Tabs selectedTabClassName={"text-redBody shadow-3xl rounded-lg"}>
        <TabList className="flex flex-col lg:flex-row bg-bgray rounded-lg items-center shadow-3xl mx-auto  lg:w-fit w-full mt-12 mb-20">
          <Tab
            onClick={handleShowSectionsSkill}
            className="transition cursor-pointer	 duration-500 font-bold lg:font-normal text-center rounded-l-lg text-xl hover:shadow-3xl hover:rounded-lg  hover:text-redBody  w-full lg:w-auto py-8 px-20 "
          >
            ProFessional Skills
          </Tab>
          <Tab
            onClick={handleShowSectionsExperience}
            className="transition cursor-pointer duration-500 font-bold lg:font-normal text-center rounded-r-lg text-xl hover:shadow-3xl hover:rounded-lg hover:text-redBody w-full lg:w-auto py-8 px-28 "
          >
            Experience
          </Tab>
        </TabList>
            ...
            <section className="skill content-card">
              <div className="flex flex-col lg:flex-row justify-between w-full gap-10 lg:gap-28">
                <ul className="skills-list w-full">
                  <div>
                    <p className="text-redBody text-lg font-normal my-3">
                      Features
                    </p>
              ...
              <div className="experience-section relative">
                <div className="cards-resume w-5/12 btn-h bg-bgray btn-color  p-12  after:hover:bg-redBody">
                  <div className="flex flex-col md:flex-row items-start md:items-center justify-between">
                    <div className="title-resume">
                      <h1 className="text-bold text-3xl my-4 transition">
                        Sr. Software Engineer
                      </h1>
                      <p className="text-bold my-4 text-TGray transition ">
                  ...
                  <hr
                    className="border-[#1C1E22] my-4"
                    style={{ height: "1px" }}
                  />
                  <p className="discription-card text-xl md:text-2xl leading-relaxed  text-TGray transition">
                    Google’s hiring process is an important part of our culture.
                    Googlers care deeply about their teams and the people who
                    make them up.
                  </p>
                </div>
                ...
                <div className="cards-resume w-5/12 btn-h bg-bgray btn-color  p-12 after:hover:bg-redBody">
                  <div className="flex flex-col md:flex-row items-start md:items-center justify-between">
                    ...
                    <div className="btn-h p-4 bg-bgray text-redBody">
                      MALAYSIA
                    </div>
                  </div>
                  <hr
                  ...
                  />
                  <p className="discription-card text-xl md:text-2xl leading-relaxed  text-TGray transition">
                    A popular destination with a growing number of highly
                    qualified homegrown graduates, it's true that securing a
                    role in Malaysia isn't easy.
                  </p>
                </div>
                ...
                <div className="cards-resume w-5/12 btn-h bg-bgray btn-color  p-12 after:hover:bg-redBody">
                  ...
                  />
                  <p className="discription-card text-xl md:text-2xl leading-relaxed  text-TGray transition">
                    The India economy has grown strongly over recent years,
                    having transformed itself from a producer and
              ...
              <div className="experience-section relative">
                <div className="cards-resume w-5/12 btn-h bg-bgray btn-color  p-12  after:hover:bg-redBody">
                  ...
                  <p className="discription-card text-xl md:text-2xl leading-relaxed  text-TGray transition">
                    ...
                    people to work in various sectors of the economy or areas of
                    culture.
                  </p>
                </div>
                ...
                <div className="cards-resume w-5/12 btn-h bg-bgray btn-color  p-12 after:hover:bg-redBody">
                  ...
                  <p className="discription-card text-xl md:text-2xl leading-relaxed  text-TGray transition">
                    ...
                    an academic degree. Higher education, also called
                ...
                <div className="cards-resume w-5/12 btn-h bg-bgray btn-color  p-12 after:hover:bg-redBody">
                  ...
                  />
                  <p className="discription-card text-xl md:text-2xl leading-relaxed  text-TGray transition">
                    Secondary education or post-primary education covers two
                    phases on the International Standard Classification of
                    Education scale.
                  </p>
                </div>
              </div>
