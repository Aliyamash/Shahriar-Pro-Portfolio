        ...
        <div className="container mx-auto px-5 mb-50 lg:p-28">
          <div className="my-20 lg:my-5">
            <div data-aos="fade-up">
              <p
                className="text-redBody lg:text-lg  font-bold text-center"
                id="protfolio-section"
              >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-12 ">
              <a className="transition-transform duration-700 ease-in-out transform  rounded-3xl trasition btn-h bg-bgray btn-color p-10">
                <div>
                  ...
                  <img
                    ...
                    src="/icon-shahriarh/portfolio/collage.png"
                    width={30}
                    alt="icon"
                  />
                  <div className="flex justify-between my-8">
                    <h2 className="text-redBody text-lg  font-bold ">
                      Gallery
                    </h2>
                    <button className="flex">
                      {" "}
                      <img
                        src="/icon-shahriarh/portfolio/whiteHeart.png"
                        alt=""
                      />
                      496
                    </button>
                  ...
                  <div>
                    <p
                      className="transition duration-500 text-3xl leading-normal hover:text-redBody hover:cursor-pointer"
                    ...
                    >
                      ...
                      {hoveredItems1 ? (
                        <img
                          ...
                          src="/icon-shahriarh/portfolio/link-up.png"
                        />
                      ) : (
                        <img
              ...
              <a className="transition-transform duration-700 ease-in-out transform  rounded-3xl trasition btn-h bg-bgray btn-color p-10 	">
                <div>
                  ...
                  <img
                    className="absolute right-12 top-12 opacity-40"
                    src="/icon-shahriarh/portfolio/video-call.png"
                    width={30}
                    alt="icon"
                  />
                  <div className="flex justify-between my-8">
                  ...
                  <div>
                    <p
                      className="transition duration-500 text-3xl leading-normal hover:text-redBody hover:cursor-pointer "
                      onClick={() => setWorkSamples(true)}
                      onMouseEnter={() => setHoveredItems2(true)}
                      onMouseLeave={() => setHoveredItems2(false)}
                    >
              ...
              <a className="transition-transform duration-700 ease-in-out transform  rounded-3xl trasition btn-h bg-bgray btn-color p-10 	">
                <div>
                  ...
                  <img
                    className="absolute right-12 top-12 opacity-40"
                    src="/icon-shahriarh/portfolio/link.png"
                    width={30}
                    alt="icon"
                  />
                  <div className="flex justify-between my-8">
                  ...
                  <div>
                    <p
                      className="transition duration-500 text-3xl leading-normal hover:text-redBody hover:cursor-pointer"
                      onClick={() => setWorkSamples(true)}
                      onMouseEnter={() => setHoveredItems3(true)}
                      onMouseLeave={() => setHoveredItems3(false)}
                    >
                ...
                <div>
                  ...
                  <div>
                    <p
                      className="transition duration-500 text-3xl leading-normal hover:text-redBody hover:cursor-pointer"
                      onClick={() => setWorkSamples(true)}
                      onMouseEnter={() => setHoveredItems4(true)}
                      onMouseLeave={() => setHoveredItems4(false)}
                    >
                ...
                <div>
                  ...
                  <div className="flex justify-between my-8">
                    ...
                    <button className="flex">
                      {" "}
                      <img
                        src="/icon-shahriarh/portfolio/redHeart.png"
                        alt=""
                      />
                      293
                    </button>
                  ...
                  <div>
                    <p
                      className="transition duration-500 text-3xl leading-normal hover:text-redBody hover:cursor-pointer"
                      onClick={() => setWorkSamples(true)}
                      onMouseEnter={() => setHoveredItems5(true)}
                      onMouseLeave={() => setHoveredItems5(false)}
                    >
                ...
                <div>
                  ...
                  <div>
                    <p
                      className="transition duration-500 text-3xl leading-normal hover:text-redBody hover:cursor-pointer"
                      onClick={() => setWorkSamples(true)}
                      onMouseEnter={() => setHoveredItems6(true)}
                      onMouseLeave={() => setHoveredItems6(false)}
                    >
